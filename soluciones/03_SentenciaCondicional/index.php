	...
	<div id="container">
		...
		<ol>
			...
			Vamos a ampliar uno de los ejercicios de la relación anterior para considerar las horas extras. Escribe
                        un programa que calcule el salario semanal de un trabajador teniendo en cuenta que las horas ordinarias
                        (40 primeras horas de trabajo) se pagan a 12 euros la hora. A partir de la hora 41, se pagan a 16 euros
                        la hora.
		    <br /><a href="04.php">&gt;&gt; Solución</a>
		    </li>

		    <li>
                        Realiza un programa que resuelva una ecuación de primer grado (del tipo <i>ax+b=0</i>).
		    <br /><a href="05.php">&gt;&gt; Solución</a>
		    </li>

		    <li>
                        Realiza un programa que calcule el tiempo que tardará en caer un objeto desde una altura <i>h</i>.
                        Aplica la fórmula <i>t=&#8730;(2h/g)</i> siendo <i>g=9.81m/s<sup>2</sup></i>
			...
			Realiza un programa que resuelva una ecuación de segundo grado
                        (del tipo <i>ax<sup>2</sup>+bx+c=0</i>).
			...
			Realiza un programa que nos diga si hay probabilidad de que nuestra pareja
                        ...
                        contestará con verdadero o falso. Puedes utilizar radio buttons. Cada
                        pregunta contestada como verdadero sumará 3 puntos. Las preguntas contestadas
                        con falso no suman puntos. Utiliza el fichero <i>test_infidelidad.txt</i> para
                        obtener las preguntas y las conclusiones del programa.
			...
			Realiza un programa que diga si un número entero positivo
                        introducido por teclado es capicúa. Se permiten números
                        de hasta 5 cifras.

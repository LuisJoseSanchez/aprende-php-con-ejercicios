...
<html>
	...
	<div id="container">
		...
		<ol>
		    ...
		    <li>Escribe un programa que muestre por pantalla 10 palabras en inglés junto a su correspondiente
		    ...
		    <li>Escribe un programa que muestre tu horario de clase mediante una tabla. Aunque se puede hacer
		    ...
		    <li>Escribe un programa que utilice las variables $x y $y. Asignales los valores 144 y 999 respectivamente.
		    ...
		    <li>Crea las variables $nombre, $direccion y $telefono y asígnales los valores adecuados. Muestra los
		    valores por pantalla de tal forma que el resultado sea el mismo que el del ejercicio 2.
		    <br /><a href="07.php">&gt;&gt; Solución</a>
		    </li>

		    <li>Realiza un conversor de euros a pesetas. La cantidad en euros que se quiere convertir deberá estar
		    almacenada en una variable.
		    <br /><a href="08.php">&gt;&gt; Solución</a>
		    </li>

		    <li>Realiza un conversor de pesetas a euros. La cantidad en pesetas que se quiere convertir deberá
		    estar almacenada en una variable.
		    <br /><a href="09.php">&gt;&gt; Solución</a>
		    </li>

		    <li>Escribe un programa que pinte por pantalla una pirámide rellena a base de asteriscos. La base de
		    la pirámide debe estar formada por 9 asteriscos.
		    <br /><a href="10.php">&gt;&gt; Solución</a>
		    </li>

		    <li>Igual que el programa anterior, pero esta vez la pirámide estará hueca (se debe ver únicamente el
		    contorno hecho con asteriscos).
		    <br /><a href="11.php">&gt;&gt; Solución</a>
		    </li>

		    <li>Igual que el programa anterior, pero esta vez la pirámide debe aparecer invertida, con el vértice
		    hacia abajo.
